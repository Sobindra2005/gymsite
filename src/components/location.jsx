...
const Location = () => {
    return (
        <section id='Service&facilities' className="bg-white pb-16  sm:px-6 lg:px-8 ">
            <div className="max-w-7xl flex gap-5  mx-auto px-4 sm:px-6  rounded-lg  lg:px-8 container p-4">

                <div className='flex gap-5 mx-auto  bg-black rounded-lg text-gray-900 container p-4'> <div className='w-full '>
